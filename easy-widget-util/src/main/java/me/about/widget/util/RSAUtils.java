...
public class RSAUtils {
    ...
    public static void main (String[] args) throws Exception {
        ...
        publicKey = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJeqthq05x37jepIElgBPtGraIRlmu4xL4_FwRFwZnlmnOrZA8-Z5nHC2qyZsiUx5Cdeb6MCUnoZE6yvfNywiasCAwEAAQ";
        System.out.println("公钥加密——私钥解密");
        String str = "Winning@abc||" + System.currentTimeMillis();
